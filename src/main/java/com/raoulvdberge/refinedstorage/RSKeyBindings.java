...
public final class RSKeyBindings {
    ...
    public static final KeyBinding OPEN_WIRELESS_CRAFTING_GRID = new KeyBinding("key.refinedstorage.openWirelessCraftingGrid", KeyConflictContext.IN_GAME, 0, "Refined Storage");
