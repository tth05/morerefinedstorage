...
public class TileFluidStorage extends TileNode<NetworkNodeFluidStorage> {
    ...
    public static final TileDataParameter<Integer, TileFluidStorage> COMPARE = FilterConfig.createCompareParameter();
    public static final TileDataParameter<Integer, TileFluidStorage> MODE = FilterConfig.createFilterModeParameter();
