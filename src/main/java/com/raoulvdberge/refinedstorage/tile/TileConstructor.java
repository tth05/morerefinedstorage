...
public class TileConstructor extends TileNode<NetworkNodeConstructor> {
    public static final TileDataParameter<Integer, TileConstructor> COMPARE = RSTileConfiguration.createCompareParameter();
    public static final TileDataParameter<Integer, TileConstructor> TYPE = RSTileConfiguration.createFilterTypeParameter();
