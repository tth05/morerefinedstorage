...
public class TileConstructor extends TileNode<NetworkNodeConstructor> {
    public static final TileDataParameter<Integer, TileConstructor> COMPARE = FilterConfig.createCompareParameter();
    public static final TileDataParameter<Integer, TileConstructor> TYPE = FilterConfig.createFilterTypeParameter();
