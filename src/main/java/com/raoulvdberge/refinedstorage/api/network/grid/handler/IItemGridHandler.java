...
public interface IItemGridHandler {
     ...
     */
    void onExtract(EntityPlayerMP player, ItemStack stack, int preferredSlot, int flags);
     ...
     * @param flags         how we are extracting, see the flags in {@link IItemGridHandler}
     */
    void onExtract(EntityPlayerMP player, UUID id, int preferredSlot, int flags);
     ...
     */
    @Nullable
    ItemStack onInsert(EntityPlayerMP player, ItemStack stack, boolean single);
     ...
     *
     * @param player    the player
     * @param id        the item stack id, this id is the id from {@link com.raoulvdberge.refinedstorage.api.util.StackListEntry}
     ...
     */
    void onCraftingPreviewRequested(EntityPlayerMP player, UUID id, int quantity, boolean noPreview);
