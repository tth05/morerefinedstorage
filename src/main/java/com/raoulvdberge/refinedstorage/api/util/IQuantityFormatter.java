...
public interface IQuantityFormatter {
     ...
     */
    @Deprecated
    default String format(int qty) {
        return this.format((long)qty);
    }
     ...
     * @return the formatted quantity
     */
    String formatInBucketForm(long qty);
     ...
     * @return the formatted quantity
     */
    String formatInBucketFormWithOnlyTrailingDigitsIfZero(long qty);
}
