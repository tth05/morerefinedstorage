...
public class RSConfig {
    ...
    private void loadConfig() {
        ...
        diskDriveUsage = config.getInt("diskDrive", ENERGY, 5, 1, Integer.MAX_VALUE, "The base energy used by Disk Drives");
        ...
        externalStorageUsage = config.getInt("externalStorage", ENERGY, 1, 1, Integer.MAX_VALUE, "The base energy used by External Storages");
        ...
        networkReceiverUsage = config.getInt("networkReceiver", ENERGY, 1, 1, Integer.MAX_VALUE, "The energy used by Network Receivers");
